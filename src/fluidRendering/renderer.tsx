...
function makeBrowserShellDiv(divId: string, layout: string, documentId: string, mode: string) {
    ...
    const shareUrlDisplayMode = mode === "frs" ? 'inline-block': 'none';
    ...
    <div class="window browser">
        <div class="header">
            ...
            <a href=${shareUrl} target="_blank" title="Open in new tab" class="share-button" style="display:${shareUrlDisplayMode}">
