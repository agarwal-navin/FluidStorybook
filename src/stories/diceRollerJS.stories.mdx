...
<Canvas>
  <Story name="Local Server">
    <FluidLoader factory={DiceRollerContainer} title={"Dice Roller JS"} view={DiceRollerView} viewType="js"></FluidLoader>
  </Story>
  <Story name="Fluid Relay Service">
    <FluidLoader factory={DiceRollerContainer} title={"Dice Roller JS"} view={DiceRollerView} viewType="js" mode={"frs"}></FluidLoader>
  </Story>
</Canvas>
