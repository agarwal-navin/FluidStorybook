...
<Canvas>
  <Story name="Local Server">
    <FluidLoader factory={DiceRollerContainer} title={"Dice Roller"} view={DiceRollerView} viewType="react"></FluidLoader>
  </Story>
  <Story name="Fluid Relay Service">
        <FluidLoader factory={DiceRollerContainer} title={"Dice Roller"} view={DiceRollerView} viewType="react" mode={"frs"}></FluidLoader>
  </Story>
</Canvas>
