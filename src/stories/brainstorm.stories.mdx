...
<Canvas>
  <Story name="Local Server">
    <FluidLoader factory={NoteroContainerFactory} title={"Brainstorm"} view={NoteroView} viewType="react"></FluidLoader>
  </Story>
  <Story name="Fluid Relay Service">
    <FluidLoader factory={NoteroContainerFactory} title={"Brainstorm"} view={NoteroView} viewType="react" mode={"frs"}></FluidLoader>
  </Story>
</Canvas>
