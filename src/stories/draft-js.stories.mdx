...
<Canvas>
  <Story name="Local Server">
    <FluidLoader factory={FluidDraftJsContainer} title={"Draft-JS"} view={FluidDraftJsView} viewType="react"></FluidLoader>
  </Story>
  <Story name="Fluid Relay Service">
    <FluidLoader factory={FluidDraftJsContainer} title={"Draft-JS"} view={FluidDraftJsView} viewType="react" mode="frs"></FluidLoader>
  </Story>
</Canvas>
